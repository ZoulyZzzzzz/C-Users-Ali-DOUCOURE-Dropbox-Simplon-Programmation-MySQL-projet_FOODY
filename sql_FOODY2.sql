...
alter table Fournisseur modify Pays varchar(20);
...
LOAD DATA LOCAL INFILE  'C:/Users/Ali DOUCOURE/Dropbox/Simplon/Programmation/MySQL/projet_FOODY/detailsCommande.csv'
...
LOAD DATA LOCAL INFILE  'C:/Users/Ali DOUCOURE/Dropbox/Simplon/Programmation/MySQL/projet_FOODY/commande.csv'
INTO TABLE commande
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE  'C:/Users/Ali DOUCOURE/Dropbox/Simplon/Programmation/MySQL/projet_FOODY/produit.csv'
INTO TABLE produit
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
INSERT INTO `foody`.`fournisseur` (`NoFour`, `Societe`, `Contact`, `Fonction`, `Adresse`, `Ville`, `CodePostal`, `Pays`, `Tel`, `Fax`) VALUES ('22', 'Zaanse Snoepfabriek', 'Dirk Luchte', 'Accounting Manager', '\"Verkoop\nRijnweg 22\"', 'Zaandam', '9999 ZZ', 'Netherlands', '(12345) 1212', '(12345) 1210');
